...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/main_picture.svg
  String get mainPicture => 'assets/icons/main_picture.svg';

  /// List of all assets
  List<String> get values => [heart, mainPicture];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/heart_picture.png
